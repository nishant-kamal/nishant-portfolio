      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .progress-bar-track {
          ...
          height: 2px; background: var(--border); z-index: 1000;
        }
        .progress-bar-fill {
          height: 100%;
        ...
        .side-nav-item:hover .side-nav-dot { background: var(--text-muted); }
        ...
        .animated-section#home { padding-top: 10rem; padding-bottom: 6rem; }

        /* ── Section divider ── */
        .section-divider {
          display: flex; align-items: center; gap: 1.2rem;
          opacity: 0.5; margin: 0 0 3.5rem 0;
        }
        .divider-index {
        ...
        @media (max-width: 768px) {
          .side-nav, .corner-tag { display: none; }
